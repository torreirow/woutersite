      ...
      return(
        <React.Fragment>
          <Typography component="div" variant="h6">
            { i18next.t('found_items_with', { search_string: this.props.searchString })}
          </Typography>
  ...
  render() {
    ...
    if(this.props.searchString != ""){
      cats = this.state.categories.map((catData) => {
        ...
        allMatchingResources = allMatchingResources.filter((value, index, self) =>
      ...
      title = "";
      if(cats.length > 0){
        title = i18next.t('found_cats_with', { search_string: this.props.searchString });
      }
    }
