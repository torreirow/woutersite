      ...
      <Box  sx={{ my: 2 }} >
        <Breadcrumbs aria-label="breadcrumb">
          ...
          <Typography
            ...
            color="common.blue"
          >
            <i style={{fontSize: '12px', marginRight: '5px', xcolor: this.state.data.icon_color}} class={this.camelToUnderscore(this.state.data.fonticonpicker)}></i> {this.state.data.title}
          </Typography>
        </Breadcrumbs>
      </Box>
    );
